...
ActiveRecord::Schema.define(version: 20161010145642) do
  ...
  create_table "players", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.integer  "stadium_weather_id", null: false
  ...
  create_table "stadium_weathers", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at",      null: false
    t.datetime "updated_at",      null: false
    t.index ["stadium_id", "month", "day"], name: "ui_stadium_weathers_01", unique: true, using: :btree
  end
